...
namespace CourseProfessorAllocation
{
    ...
    public class Analyser
    {
        ...
        Dictionary<int, Dictionary<int, int>> pfDict;  // key=professor id value=Dictionary // In Dictionary key=topicid value=expertise level
        ...
        {           
            ...
            pfDict = CreateProfessorsDictionary();  // this method would return the professor dictionary and assigned to the variable
        }
        /// <summary>
        ...
        public Dictionary<int, Dictionary<int, int>> CreateProfessorsDictionary()
        {
            ...
            List<int> ansList = new List<int>();
            List<Expertise> peList = db.GetExpertise();  // GetExpertise method will return all the professors with their topics wise expertise
            foreach (Expertise pe in peList)             // store them in peList
            {
